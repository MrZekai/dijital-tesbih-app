...
Bunun tek şartı var: **mevcut yükleme anahtarı (upload keystore) elinde
olmalı.** Yeni anahtar üretilmiyor — üretilirse Play paketi reddeder.

---

## 2. Yükleme anahtarını nereden bulacaksın
...
```
base64 -w0 /c/Users/limno/Downloads/upload.keystore > /c/Users/limno/Downloads/keystore.b64
```
...
gh run watch
gh run download --name zikirmatik-production-aab --dir /c/Users/limno/Downloads --clobber
```
...
node scripts/verify-aab.js /c/Users/limno/Downloads/Zikirmatik-1.1.0-1029.aab \
  --cert "94:B7:FE:7C:45:1A:9E:17:D3:12:C8:08:F3:F2:BD:BA:9A:3F:17:03:36:72:17:C9:26:5F:64:6F:48:2D:95:43" \
